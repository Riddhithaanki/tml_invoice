          ...
          <ul class="nav nav-tabs d-flex justify-content-between" id="invoiceTabs" style="overflow-x: unset;">
                        <div class="d-flex">
                            <!-- <li class="nav-item">
                                ...
                                href="{{ url('waitingtime-newinvoice-list') }}/withtipticket?update_type={{ request('update_type') }}&invoice_type={{ request('invoice_type') }}"
                                role="tab">With Tip Ticket</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link {{ request('type') === 'withouttipticket' ? 'active' : '' }} waves-effect"
                                href="{{ url('waitingtime-newinvoice-list') }}/withouttipticket?update_type={{ request('update_type') }}&invoice_type={{ request('invoice_type') }}"
                                role="tab">Without Tip Ticket</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link {{ request('type') === 'missingtipticket' ? 'active' : '' }} waves-effect"
                                href="{{ url('waitingtime-newinvoice-list') }}/missingtipticket?update_type={{ request('update_type') }}&invoice_type={{ request('invoice_type') }}"
                                role="tab">Missing Tip Ticket</a>
                            </li> -->
                             <li class="nav-item">
                            <a class="nav-link {{ !request()->update_type || request()->update_type === 'loads' ? 'active' : '' }}"
                            href="{{ route('waitingtime.newindex', [
                        ...
                        <div class="d-flex-new">
                            <li class="nav-item">
                                ...
                                href="{{ url('waitingtime-newinvoice-list') }}/{{ request('type') ?? 'withtipticket' }}?invoice_type=preinvoice">
                                    Pre Invoice
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link {{ request('invoice_type') === 'readyinvoice' ? 'active' : '' }} waves-effect"
                                href="{{ url('waitingtime-newinvoice-list') }}/{{ request('type') ?? 'withtipticket' }}?invoice_type=readyinvoice">
                                    Ready Invoice
                                </a>
                            </li>
                              <li class="nav-item">
                            <a class="nav-link {{ request('invoice_type') === 'holdinvoice' ? 'active' : '' }} waves-effect"
                                href="{{ url('waitingtime-newinvoice-list') }}/{{ request('type') ?? 'withtipticket' }}?invoice_type=holdinvoice">
                                    Hold Invoice
                                </a>
                            </li>
                        </div>
