    ...
    <div class="table-container mt-4">
        <div class="tab-container mb-3">
            <ul class="nav nav-tabs" id="invoiceTabs">
                <li class="nav-item">
                    <a class="nav-link active" id="with-tip-tab" data-toggle="tab" href="#withtip" role="tab">With Tip Ticket</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="without-tip-tab" data-toggle="tab" href="#withouttip" role="tab">Without Tip Ticket</a>
                </li>
                <li class="nav-item ml-auto">
                    <a class="nav-link" id="pre-invoice-tab" data-toggle="tab" href="#preinvoice" role="tab">Pre Invoice</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="ready-invoice-tab" data-toggle="tab" href="#readinvoice" role="tab">Ready Invoice</a>
                </li>
            </ul>
        </div>
