    ...
    <div class="table-container mt-4">
        <div class="tab-container mb-3">
            <ul class="nav nav-tabs" id="invoiceTabs">
                <li class="nav-item">
                    <a class="nav-link active" id="loads" data-toggle="tab" href="#loads" role="tab">Loads</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="tonnage" data-toggle="tab" href="#tonnage" role="tab">Tonnage</a>
                </li>
            </ul>
        </div>
