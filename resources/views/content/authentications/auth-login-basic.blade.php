...
<body>
    ...
    <div class="authentication-wrapper authentication-cover">
        ...
        <a href="index.html" class="auth-cover-brand d-flex align-items-center gap-2">
            <span class="app-brand-text demo text-heading fw-bold">Fleet Focus Pro</span>
        </a>
        <!-- /Logo -->
        ...
        <div class="authentication-inner row m-0">
            ...
            <div class="d-flex col-12 col-lg-5 col-xl-4 align-items-center authentication-bg position-relative py-sm-5 px-4 py-4">
                <div class="w-px-400 mx-auto pt-5 pt-lg-0">
                    <h4 class="mb-2">Welcome to Fleet Focus Pro! 👋</h4>
                    ...
                    <form id="formAuthentication" class="mb-3" action="{{url('/login-admin')}}" method="POST">
                        ...
                        <a href="{{ route('register') }}" class="float-end mb-1">
